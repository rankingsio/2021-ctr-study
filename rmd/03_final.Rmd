...
# se, we just average the LOESS by day and lose precision...
...
As we previously saw, there is a high variability in the rankings, even day to day. We can use an indexed line plot, all law firms finishing at 0 on April 5th, to show the fluctuations over time.  
...
* The rankings seem to fluctuate less after March 19th. The variance of the ranking befor March 19th is around ±5. After it seems to be ±3.  
...
slopegraph <- ggplot(data = results_augm_long) +
  ...
  labs(
    ...
    subtitle = "In pink, the average of all samples.\nHover on each line to highlight a particular sample."
  ) + 
  # average:
  geom_line(
